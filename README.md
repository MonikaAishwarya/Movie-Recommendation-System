...
This project is a **Hybrid Movie Recommendation System** developed using **Python, Scikit-learn, and Streamlit**. The system combines **Content-Based Filtering** and **Collaborative Filtering** techniques to generate personalized movie recommendations.
...
The hybrid approach improves recommendation quality by combining movie similarity with user behavior patterns, resulting in more accurate and personalized recommendations.
...
- Duplicate Movie Title Handling
...
![Recommendation Input](screenshots/recommendation_input.png)
...
The Hybrid Recommendation System combines the strengths of Content-Based Filtering and Collaborative Filtering.
...
- Utilizes Both User Preferences and User Behavior
...
│   ├── recommendation_output_1.png
│   ├── recommendation_output_2.png
│   ├── recommendation_output_3.png
│   ├── recommendation_output_4.png
│   ├── input.png
│   └── output.png
│
├── src/
